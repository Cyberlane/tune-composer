...
exports.convertTuneToNotes = exports.cleanTuneData = undefined;

var _maps = require('./maps');

var cleanTuneData = exports.cleanTuneData = function cleanTuneData(data) {
  return data.trim().replace(/( *|\t*)(NOTE\(\w+, \d\))(, *)\n?/g, '$2\n').replace(/\nEND_MARKER/g, '').split('\n');
};

var convertTuneToNotes = exports.convertTuneToNotes = function convertTuneToNotes(tune) {
  var segments = /NOTE\(T_(\w+), (\d)\)/g.exec(tune);
  var note = {
    note: _maps.toneMap[segments[1]],
    duration: Number(_maps.durationMap[segments[2]]) / 50
  };
  return note;
};

},{"./maps":6}],3:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var playTune = exports.playTune = document.getElementById('play-tune');
var clear = exports.clear = document.getElementById('clear');
var loadTune = exports.loadTune = document.getElementById('load-tune');
var tuneList = exports.tuneList = document.getElementById('tune-list');
var tuneData = exports.tuneData = document.getElementById('tune-data');
var convertedData = exports.convertedData = document.getElementById('converted-data');
...
var createOption = exports.createOption = function createOption(value, text) {
...
var _convertTune = require('./convert-tune');

var _playQueue = require('./play-queue');

var _tunes = require('./tunes');

var tunes = _interopRequireWildcard(_tunes);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var synth = new _tone2.default.MonoSynth().toMaster();

var playTuneClick = function playTuneClick() {
  _domElements.playTune.setAttribute('disabled', 'disabled');
  var notes = (0, _convertTune.cleanTuneData)(_domElements.tuneData.value).map(_convertTune.convertTuneToNotes);

  var _queueNotesForPlay = (0, _playQueue.queueNotesForPlay)(synth, notes),
      totalDuration = _queueNotesForPlay.totalDuration,
      log = _queueNotesForPlay.log;

  _domElements.convertedData.value = log;
  (0, _playQueue.playQueuedNotes)(totalDuration).then(function () {
    return _domElements.playTune.removeAttribute('disabled');
  });
};

var clearClick = function clearClick() {
  _domElements.tuneData.value = '';
  _domElements.convertedData.value = '';
};

var loadTuneClick = function loadTuneClick() {
  _domElements.tuneData.value = tunes[_domElements.tuneList.options[_domElements.tuneList.selectedIndex].value];
};

_domElements.playTune.addEventListener('click', playTuneClick, false);
_domElements.clear.addEventListener('click', clearClick, false);
_domElements.loadTune.addEventListener('click', loadTuneClick, false);

Object.keys(tunes).forEach(function (tune) {
  var option = (0, _domHelper.createOption)(tune, tune);
  _domElements.tuneList.add(option);
});

},{"./convert-tune":2,"./dom-elements":3,"./dom-helper":4,"./play-queue":7,"./tunes":8,"tone":1}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var toneMap = exports.toneMap = {
  C: 130.81,
  CS: 138.59,
  D: 146.83,
  EB: 155.56,
...
var durationMap = exports.durationMap = {
  0: 2,
  1: 4,
  2: 6,
  3: 8,
...
exports.queueNotesForPlay = exports.playQueuedNotes = undefined;
...
var playQueuedNotes = exports.playQueuedNotes = function playQueuedNotes(totalDuration) {
  return new Promise(function (r) {
    _tone2.default.Transport.start('+0.1');
    setTimeout(function () {
...
var queueNotesForPlay = exports.queueNotesForPlay = function queueNotesForPlay(instrument, notes) {
  var totalDuration = 0;
  var log = '';
